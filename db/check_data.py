class CheckData:
    ...
    def insert_new_product(self, file_product, model, date_available, date_added, date_modified):
        product = file_product['oc_product']
        request = f"INSERT INTO oc_product (" \
    ...
    def insert_new_product_description(self, file_product, product_id, name, meta_title):
        product = file_product['oc_product_description']
        request = f"INSERT INTO oc_product_description (" \
